...
export const COLLECTIBLE_CATEGORIES: CollectibleCategory[] = [
  ...
  // ── Pillars of the Fallen — 20 (VERIFIED: names and regions) ─────────────────
  {
    ...
    items: [
      // Yotei Grasslands (4)
      { id: 'coll_pillars_1',  name: 'Pillar of Fallen Farmers',       region: 'Yotei Grasslands', subArea: 'Ruined farmstead, southern Yotei Grasslands — among the collapsed field walls',          placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_2',  name: 'Watchtower Pass Pillar',          region: 'Yotei Grasslands', subArea: 'Hilltop watchtower ruins, western Yotei Grasslands — beside the crumbled guard post',   placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_3',  name: 'Riverside Memorial Pillar',       region: 'Yotei Grasslands', subArea: 'Riverbank trail, central Yotei Grasslands — on the low embankment above the water',      placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_4',  name: 'Eastern Field Pillar',            region: 'Yotei Grasslands', subArea: 'Open farmland, eastern Yotei Grasslands — standing alone at the edge of the crop field', placeholder: false, verified: true, missable: false },
      // Ishikari Plain (3)
      { id: 'coll_pillars_5',  name: 'Merchant Road Pillar',            region: 'Ishikari Plain',   subArea: 'Old trade road, central Ishikari Plain — at the roadside beside a fallen cart',          placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_6',  name: 'River Ford Pillar',               region: 'Ishikari Plain',   subArea: 'Shallow river ford, eastern Ishikari Plain — on the near bank of the crossing',          placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_7',  name: 'Northern Settlement Pillar',      region: 'Ishikari Plain',   subArea: 'Abandoned settlement ruins, northern Ishikari Plain — within the collapsed outer wall',   placeholder: false, verified: true, missable: false },
      // Teshio Ridge (3)
      { id: 'coll_pillars_8',  name: 'Frozen Pass Pillar',              region: 'Teshio Ridge',     subArea: 'Icy mountain pass, southern Teshio Ridge — at the narrowest point between the cliffs',   placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_9',  name: 'High Overlook Pillar',            region: 'Teshio Ridge',     subArea: 'Exposed ridge overlook, central Teshio Ridge — on the promontory above the snowline',    placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_10', name: 'Wilderness Trail Pillar',         region: 'Teshio Ridge',     subArea: 'Remote forest trail, northern Teshio Ridge — where the path narrows into dense trees',   placeholder: false, verified: true, missable: false },
      // Tokachi Range (4)
      { id: 'coll_pillars_11', name: 'Summit Route Pillar',             region: 'Tokachi Range',    subArea: 'Upper mountain route, northern Tokachi Range — along the final approach to the summit',   placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_12', name: 'Valley Crossing Pillar',          region: 'Tokachi Range',    subArea: 'Alpine valley floor, central Tokachi Range — at the narrow crossing between two ridges',  placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_13', name: "Hunter's Camp Pillar",            region: 'Tokachi Range',    subArea: 'Abandoned hunting camp, eastern Tokachi Range — beside the fire pit at the old campsite', placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_14', name: 'Snowfield Pillar',                region: 'Tokachi Range',    subArea: 'Broad snowfield, western Tokachi Range — rising from the open snow-covered expanse',      placeholder: false, verified: true, missable: false },
      // Nayoro Wilds (3)
      { id: 'coll_pillars_15', name: 'Forest Edge Pillar',              region: 'Nayoro Wilds',     subArea: 'Treeline boundary, western Nayoro Wilds — where the open land meets the dense forest',    placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_16', name: 'River Confluence Pillar',         region: 'Nayoro Wilds',     subArea: 'River junction, central Nayoro Wilds — on the bank where two waterways meet',            placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_17', name: 'Ruined Village Pillar',           region: 'Nayoro Wilds',     subArea: 'Abandoned village ruins, eastern Nayoro Wilds — inside the broken settlement perimeter',  placeholder: false, verified: true, missable: false },
      // Oshima Coast (3)
      { id: 'coll_pillars_18', name: 'Clifftop Pillar',                 region: 'Oshima Coast',     subArea: 'Sea cliff summit, northern Oshima Coast — on the flat clifftop above the crashing surf',  placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_19', name: 'Harbor Road Pillar',              region: 'Oshima Coast',     subArea: 'Old harbor approach road, central Oshima Coast — at the edge of the overgrown port path', placeholder: false, verified: true, missable: false },
      { id: 'coll_pillars_20', name: 'Tidal Flats Pillar',              region: 'Oshima Coast',     subArea: 'Exposed tidal flats, southern Oshima Coast — accessible at low tide across the mud flat',  placeholder: false, verified: true, missable: false },
    ],
  },
