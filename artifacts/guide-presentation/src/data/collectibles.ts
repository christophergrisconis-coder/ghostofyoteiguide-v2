...
export const COLLECTIBLE_CATEGORIES: CollectibleCategory[] = [
  ...
  // ── Ainu Items — 30 (VERIFIED: names) ────────────────────────────────────────
  {
    ...
    items: [
      // Region distribution is placeholder until in-game locations are confirmed.
      // Items concentrated in Nayoro Wilds per the verified data, others spread across regions.
      { id: 'coll_ainu_1',  name: 'Repunkur Canteen', region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_2',  name: 'Ninkari',          region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_3',  name: 'Raoma',            region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_4',  name: 'Makiri',           region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_5',  name: 'Ninketeyep',       region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_6',  name: 'Mukkuri',          region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_7',  name: 'Ikupasuy',         region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_8',  name: 'Ku-e-shinok Ring', region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_9',  name: 'Cispo',            region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_10', name: 'Clothes for the Dead', region: 'Nayoro Wilds', placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_11', name: 'Traded Furs',      region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_12', name: 'Kiray',            region: 'Nayoro Wilds',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_13', name: 'Tepkeri',          region: 'Yotei Grasslands', placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_14', name: 'Tamasai',          region: 'Yotei Grasslands', placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_15', name: 'Kuwari',           region: 'Yotei Grasslands', placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_16', name: 'Tanpakuop',        region: 'Yotei Grasslands', placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_17', name: 'Karop',            region: 'Yotei Grasslands', placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_18', name: 'Kuyoy',            region: 'Ishikari Plain',   placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_19', name: 'Newsar-kamuy',     region: 'Ishikari Plain',   placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_20', name: 'Tesma',            region: 'Ishikari Plain',   placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_21', name: 'Marek',            region: 'Ishikari Plain',   placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_22', name: 'Hos',              region: 'Tokachi Range',    placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_23', name: 'Sitopera',         region: 'Tokachi Range',    placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_24', name: 'Sinta',            region: 'Tokachi Range',    placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_25', name: 'Menokomakir',      region: 'Tokachi Range',    placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_26', name: 'Matampus',         region: 'Teshio Ridge',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_27', name: 'Mat Loom',         region: 'Teshio Ridge',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_28', name: 'Lacquerware',      region: 'Teshio Ridge',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_29', name: 'Niesike',          region: 'Oshima Coast',     placeholder: false, verified: true, missable: false },
      { id: 'coll_ainu_30', name: 'Citarpe Cape',     region: 'Oshima Coast',     placeholder: false, verified: true, missable: false },
    ],
  },
